...
readonly SRA_ACCESSION="strains.txt"
readonly ARG="$1"
readonly SRA_FOLDER="/mnt/data/CbFastq"
...
qc_fastq() {
	...
	fastqc --outdir $SRA_FOLDER/$line/pre --extract --threads 4 \
	       $SRA_FOLDER/$line/${line}_L001_R1_001.fastq \
	       $SRA_FOLDER/$line/${line}_L001_R2_001.fastq

	# QC of the reads (Clipping adapters)
	progress_prompt "Clipping remaining adapters "
	bbduk.sh in=$SRA_FOLDER/$line/${line}_L001_R1_001.fastq \
		 in2=$SRA_FOLDER/$line/${line}_L001_R2_001.fastq \
